                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Selamat Datang di Management Sekolah 🎉</h5>
                          <p class="mb-4">
                            Silahkan isi dan lihat data sekolah hari ini
                          </p>
                        </div>
                      </div>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Total Siswa</h5>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="text-center fw-semibold pt-3 mb-2">72% Sekolah Bertumbuh</div>
