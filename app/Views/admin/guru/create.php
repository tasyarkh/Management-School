        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">MS</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?= base_url('sissep'); ?>" class="menu-link">
                    <div data-i18n="Accordion">Kelas 10</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?= base_url('sislas'); ?>" class="menu-link">
                    <div data-i18n="Alerts">Kelas 11</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?= base_url('sisdu'); ?>" class="menu-link">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"></i><?= session('namaUser'); ?></span>
                            <small class="text-muted"></i><?= session('jabatan'); ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Masukan Data Guru</h5>
                      <small class="text-muted float-end">Data guru</small>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="<?= base_url('/guru/save'); ?>">
                      <?= csrf_field(); ?>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Nama Guru</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                              id="namaGuru" name="namaGuru"
                            />
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Mata Pelajaran</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              id="mapel" name="mapel"
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Tasya Ramadhinta</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
