        ...
        <nav
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?= session('namaUser'); ?></span>
                            <small class="text-muted"><?= session('jabatan'); ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <h5 class="card-header">Table Data Guru</h5>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr class="table-default">
                        <td><i class="fab fa-sketch fa-lg text-warning me-3"></i> <strong><?= $row['namaGuru']; ?></strong></td>
                        <td><?= $row['nip']; ?></td>
                        <td><?= $row['mapel']; ?></td>
                        <td><span class="badge bg-label-<?php if ($row['jk'] == 'Wanita') {
                                                                    echo 'primary';
                                                                } else {
                                                                    echo 'success';
                                                                } ?> me-1"><?= $row['jk']; ?></span></td>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-trash"></i>Apakah Guru Tersebut Sudah Tidak Terdaftar ?</h5>
            </div>
            <div class="modal-footer bg-whitesmoke br">
            <button class="btn btn-secondary close" type="button" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
             <a type="submit" class="btn btn-danger btn-ok" href="guru/delete/<?=
              $row['idGuru'] ?>">Ya</a> 
            </div>
        </div>
    </div>
